...
const Cart = ({ cart, handleUpdateCartQty, handleRemoveFromCart, handleEmptyCart }) => {
    ...
    // console.log('usempty ',isEmpty);

    const EmptyCart = () => {
        return (<Typography variant="subtitle1">
            Anda belum menambahkan barang ke keranjang, 
            <Link to="/" className={classes.link}> Silahkan menambahkan barang.</Link>
        </Typography>)
    }
        ...
        return (<>
            ...
            <div className={classes.cardDetails}>
                <Typography variant="h4">
                    Subtotal: { cart.subtotal.formatted_with_symbol.substring(0, cart.subtotal.formatted_with_symbol.length - 3) }
                </Typography>
                <div>
